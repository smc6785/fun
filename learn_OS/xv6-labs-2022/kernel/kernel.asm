...
00000000800000de <kinit>:
{
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000106:	c2e50513          	addi	a0,a0,-978 # 80021d30 <end>
...
memcmp(const void *v1, const void *v2, uint n)
{
  ...
  while(n-- > 0){
    ...
    800001a4:	fff6069b          	addiw	a3,a2,-1
    ...
    800001e6:	00c587b3          	add	a5,a1,a2
{
    ...
    800001ee:	0705                	addi	a4,a4,1
    800001f0:	fff5c683          	lbu	a3,-1(a1)
    800001f4:	fed70fa3          	sb	a3,-1(a4) # ffffffffffffefff <end+0xffffffff7ffdd2cf>
    while(n-- > 0)
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000444:	4587b783          	ld	a5,1112(a5) # 80008898 <kernel_pagetable>
...
00000000800006ec <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    80000700:	18a7be23          	sd	a0,412(a5) # 80008898 <kernel_pagetable>
}
    ...
    80000c2e:	c2dd                	beqz	a3,80000cd4 <copyinstr+0xa6>
{
  ...
  while(got_null == 0 && max > 0){
    ...
    80000cb4:	00074703          	lbu	a4,0(a4) # fffffffffffff000 <end+0xffffffff7ffdd2d0>
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000cf8:	01c48493          	addi	s1,s1,28 # 80008d10 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
    ...
    80000d0a:	197d                	addi	s2,s2,-1
    80000d0c:	0932                	slli	s2,s2,0xc
  for(p = proc; p < &proc[NPROC]; p++) {
    80000d0e:	0000ea17          	auipc	s4,0xe
    80000d12:	a02a0a13          	addi	s4,s4,-1534 # 8000e710 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    80000d94:	b5050513          	addi	a0,a0,-1200 # 800088e0 <pid_lock>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80000dd6:	197d                	addi	s2,s2,-1
    80000dd8:	0932                	slli	s2,s2,0xc
  for(p = proc; p < &proc[NPROC]; p++) {
    80000dda:	0000e997          	auipc	s3,0xe
    80000dde:	93698993          	addi	s3,s3,-1738 # 8000e710 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    80000e48:	acc50513          	addi	a0,a0,-1332 # 80008910 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    80000e70:	a7470713          	addi	a4,a4,-1420 # 800088e0 <pid_lock>
...
0000000080000ed2 <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    80000ee2:	a0290913          	addi	s2,s2,-1534 # 800088e0 <pid_lock>
...
000000008000105e <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    8000106e:	ca648493          	addi	s1,s1,-858 # 80008d10 <proc>
    80001072:	0000d917          	auipc	s2,0xd
    80001076:	69e90913          	addi	s2,s2,1694 # 8000e710 <tickslock>
    acquire(&p->lock);
...
000000008000112c <userinit>:
{
  ...
  initproc = p;
    ...
    80001144:	76a7b023          	sd	a0,1888(a5) # 800088a0 <initproc>
...
000000008000120a <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  acquire(&wait_lock);
    ...
    800012fc:	60048493          	addi	s1,s1,1536 # 800088f8 <wait_lock>
...
00000000800017d6 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80001814:	f0098993          	addi	s3,s3,-256 # 8000e710 <tickslock>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    80001ade:	c3650513          	addi	a0,a0,-970 # 8000e710 <tickslock>
...
clockintr()
{
  ...
  acquire(&tickslock);
    ...
    80001bae:	b6648493          	addi	s1,s1,-1178 # 8000e710 <tickslock>
  ...
  ticks++;
    ...
    80001bc0:	cec50513          	addi	a0,a0,-788 # 800088a8 <ticks>
...
sys_sleep(void)
{
  ...
  while(ticks - ticks0 < n){
    ...
    80002156:	5be98993          	addi	s3,s3,1470 # 8000e710 <tickslock>
    8000215a:	00006497          	auipc	s1,0x6
    8000215e:	74e48493          	addi	s1,s1,1870 # 800088a8 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002192:	58250513          	addi	a0,a0,1410 # 8000e710 <tickslock>
  ...
  return 0;
    ...
    800021b2:	56250513          	addi	a0,a0,1378 # 8000e710 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800021fa:	51a50513          	addi	a0,a0,1306 # 8000e710 <tickslock>
    800021fe:	00004097          	auipc	ra,0x4
    80002202:	ec6080e7          	jalr	-314(ra) # 800060c4 <acquire>
  xticks = ticks;
    80002206:	00006497          	auipc	s1,0x6
    8000220a:	6a24a483          	lw	s1,1698(s1) # 800088a8 <ticks>
  release(&tickslock);
    8000220e:	0000c517          	auipc	a0,0xc
    80002212:	50250513          	addi	a0,a0,1282 # 8000e710 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    ...
    8000224a:	4e250513          	addi	a0,a0,1250 # 8000e728 <bcache>
  ...
  bcache.head.prev = &bcache.head;
    ...
    8000225a:	4d278793          	addi	a5,a5,1234 # 80016728 <bcache+0x8000>
    8000225e:	00014717          	auipc	a4,0x14
    80002262:	73270713          	addi	a4,a4,1842 # 80016990 <bcache+0x8268>
    80002266:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    8000226a:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    8000226e:	0000c497          	auipc	s1,0xc
    80002272:	4d248493          	addi	s1,s1,1234 # 8000e740 <bcache+0x18>
...
bread(uint dev, uint blockno)
{
  ...
  acquire(&bcache.lock);
    ...
    800022d2:	45a50513          	addi	a0,a0,1114 # 8000e728 <bcache>
    800022d6:	00004097          	auipc	ra,0x4
    800022da:	dee080e7          	jalr	-530(ra) # 800060c4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    800022de:	00014497          	auipc	s1,0x14
    800022e2:	7024b483          	ld	s1,1794(s1) # 800169e0 <bcache+0x82b8>
    800022e6:	00014797          	auipc	a5,0x14
    800022ea:	6aa78793          	addi	a5,a5,1706 # 80016990 <bcache+0x8268>
    ...
    80002312:	41a50513          	addi	a0,a0,1050 # 8000e728 <bcache>
  ...
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    ...
    80002330:	6ac4b483          	ld	s1,1708(s1) # 800169d8 <bcache+0x82b0>
    80002334:	00014797          	auipc	a5,0x14
    80002338:	65c78793          	addi	a5,a5,1628 # 80016990 <bcache+0x8268>
  ...
  panic("bget: no buffers");
    ...
    80002370:	3bc50513          	addi	a0,a0,956 # 8000e728 <bcache>
...
brelse(struct buf *b)
{
  ...
  acquire(&bcache.lock);
    ...
    80002418:	31450513          	addi	a0,a0,788 # 8000e728 <bcache>
  ...
  if (b->refcnt == 0) {
    ...
    80002440:	2ec78793          	addi	a5,a5,748 # 80016728 <bcache+0x8000>
    80002444:	2b87b703          	ld	a4,696(a5)
    80002448:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    8000244a:	00014717          	auipc	a4,0x14
    8000244e:	54670713          	addi	a4,a4,1350 # 80016990 <bcache+0x8268>
  ...
  release(&bcache.lock);
    ...
    80002462:	2ca50513          	addi	a0,a0,714 # 8000e728 <bcache>
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    8000249a:	29250513          	addi	a0,a0,658 # 8000e728 <bcache>
  ...
  release(&bcache.lock);
    ...
    800024b0:	27c50513          	addi	a0,a0,636 # 8000e728 <bcache>
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    ...
    800024d6:	25650513          	addi	a0,a0,598 # 8000e728 <bcache>
  ...
  release(&bcache.lock);
    ...
    800024ec:	24050513          	addi	a0,a0,576 # 8000e728 <bcache>
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    ...
    80002518:	8f07a783          	lw	a5,-1808(a5) # 80016e04 <sb+0x1c>
...
000000008000257e <balloc>:
{
  ...
  for(b = 0; b < sb.size; b += BPB){
    ...
    8000259c:	8547a783          	lw	a5,-1964(a5) # 80016dec <sb+0x4>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    800032ca:	5ea90913          	addi	s2,s2,1514 # 800188b0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800032ee:	5f678793          	addi	a5,a5,1526 # 800188e0 <log+0x30>
    ...
    80003304:	5e460613          	addi	a2,a2,1508 # 800188e4 <log+0x34>
...
0000000080003336 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    8000333a:	5a67a783          	lw	a5,1446(a5) # 800188dc <log+0x2c>
    8000333e:	0af05d63          	blez	a5,800033f8 <install_trans+0xc2>
{
    ...
    8000335c:	588a8a93          	addi	s5,s5,1416 # 800188e0 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003360:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003362:	00015997          	auipc	s3,0x15
    80003366:	54e98993          	addi	s3,s3,1358 # 800188b0 <log>
...
00000000800033fa <initlog>:
{
  ...
  initlock(&log.lock, "log");
    ...
    80003410:	4a448493          	addi	s1,s1,1188 # 800188b0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003450:	49470713          	addi	a4,a4,1172 # 800188e0 <log+0x30>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003486:	4407ad23          	sw	zero,1114(a5) # 800188dc <log+0x2c>
...
begin_op(void)
{
  ...
  while(1){
    ...
    80003504:	3b050513          	addi	a0,a0,944 # 800188b0 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003534:	38048493          	addi	s1,s1,896 # 800188b0 <log>
  ...
  if(log.outstanding == 0){
    ...
    80003558:	35c48493          	addi	s1,s1,860 # 800188b0 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    80003574:	34048493          	addi	s1,s1,832 # 800188b0 <log>
    ...
    800035b0:	30448493          	addi	s1,s1,772 # 800188b0 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    800035de:	306a8a93          	addi	s5,s5,774 # 800188e0 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    800035e2:	00015a17          	auipc	s4,0x15
    800035e6:	2cea0a13          	addi	s4,s4,718 # 800188b0 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003668:	2607ac23          	sw	zero,632(a5) # 800188dc <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    ...
    80003688:	22c90913          	addi	s2,s2,556 # 800188b0 <log>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    800036c6:	21e70713          	addi	a4,a4,542 # 800188e0 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    800036e2:	1d278793          	addi	a5,a5,466 # 800188b0 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    800036fa:	1ba70713          	addi	a4,a4,442 # 800188b0 <log>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003730:	18470713          	addi	a4,a4,388 # 800188b0 <log>
  ...
  release(&log.lock);
    ...
    80003742:	17250513          	addi	a0,a0,370 # 800188b0 <log>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    ...
    80003898:	16450513          	addi	a0,a0,356 # 800189f8 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    ...
    800038ba:	14250513          	addi	a0,a0,322 # 800189f8 <ftable>
    800038be:	00003097          	auipc	ra,0x3
    800038c2:	806080e7          	jalr	-2042(ra) # 800060c4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    800038c6:	00015497          	auipc	s1,0x15
    800038ca:	14a48493          	addi	s1,s1,330 # 80018a10 <ftable+0x18>
    800038ce:	00016717          	auipc	a4,0x16
    800038d2:	0e270713          	addi	a4,a4,226 # 800199b0 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    ...
    800038e6:	11650513          	addi	a0,a0,278 # 800189f8 <ftable>
  ...
  return 0;
    ...
    800038fe:	0fe50513          	addi	a0,a0,254 # 800189f8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003926:	0d650513          	addi	a0,a0,214 # 800189f8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003940:	0bc50513          	addi	a0,a0,188 # 800189f8 <ftable>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003980:	07c50513          	addi	a0,a0,124 # 800189f8 <ftable>
  ...
  release(&ftable.lock);
    ...
    800039ba:	04250513          	addi	a0,a0,66 # 800189f8 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003a04:	ff850513          	addi	a0,a0,-8 # 800189f8 <ftable>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  return r;
    ...
    80003b36:	e2670713          	addi	a4,a4,-474 # 80018958 <devsw>
...
filewrite(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003bac:	c00c0c1b          	addiw	s8,s8,-1024
    ...
    80003bd6:	d8670713          	addi	a4,a4,-634 # 80018958 <devsw>
...
loadseg(pagetable_t pagetable, uint64 va, struct inode *ip, uint offset, uint sz)
{
  ...
  ustack[argc] = 0;
    ...
    8000420e:	f9078793          	addi	a5,a5,-112 # f90 <_entry-0x7ffff070>
...
argfd(int n, int *pfd, struct file **pf)
{
  ...
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
    ...
    800043d2:	01a70793          	addi	a5,a4,26 # fffffffffffff01a <end+0xffffffff7ffdd2ea>
...
create(char *path, short type, short major, short minor)
{
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    800044a8:	044ad783          	lhu	a5,68(s5) # fffffffffffff044 <end+0xffffffff7ffdd314>
...
0000000080005198 <virtio_disk_init>:
{
  ...
  *R(VIRTIO_MMIO_DRIVER_FEATURES) = features;
    ...
    80005214:	75f68693          	addi	a3,a3,1887 # ffffffffc7ffe75f <end+0xffffffff47fdca2f>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000525a:	75a48493          	addi	s1,s1,1882 # 800199b0 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    8000527e:	73e73703          	ld	a4,1854(a4) # 800199b8 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    ...
    80005296:	71e48493          	addi	s1,s1,1822 # 800199b0 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800053b6:	72650513          	addi	a0,a0,1830 # 80019ad8 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800053ca:	5eab8b93          	addi	s7,s7,1514 # 800199b0 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800053d4:	708c8c93          	addi	s9,s9,1800 # 80019ad8 <disk+0x128>
    ...
    8000543a:	f8040a13          	addi	s4,s0,-128
{
  ...
  if(write)
    ...
    80005452:	56278793          	addi	a5,a5,1378 # 800199b0 <disk>
  ...
  disk.desc[idx[0]].flags = VRING_DESC_F_NEXT;
    ...
    80005484:	00b61623          	sh	a1,12(a2) # 100c <_entry-0x7fffeff4>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    80005528:	5b490913          	addi	s2,s2,1460 # 80019ad8 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    80005554:	46078793          	addi	a5,a5,1120 # 800199b0 <disk>
    80005558:	97ba                	add	a5,a5,a4
    8000555a:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    8000555e:	00014997          	auipc	s3,0x14
    80005562:	45298993          	addi	s3,s3,1106 # 800199b0 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    8000558a:	55250513          	addi	a0,a0,1362 # 80019ad8 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    800055c2:	3f248493          	addi	s1,s1,1010 # 800199b0 <disk>
    800055c6:	00014517          	auipc	a0,0x14
    800055ca:	51250513          	addi	a0,a0,1298 # 80019ad8 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    ...
    80005642:	49a50513          	addi	a0,a0,1178 # 80019ad8 <disk+0x128>
...
timerinit()
{
  ...
  *(uint64*)CLINT_MTIMECMP(id) = *(uint64*)CLINT_MTIME + interval;
  ...
  uint64 *scratch = &timer_scratch[id][0];
    ...
    800056a0:	45470713          	addi	a4,a4,1108 # 80019af0 <timer_scratch>
...
00000000800056d8 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    800056e6:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdcacf>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    800057da:	45a50513          	addi	a0,a0,1114 # 80021c30 <cons>
  ...
  while(n > 0){
    ...
    800057ea:	44a48493          	addi	s1,s1,1098 # 80021c30 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    800057f2:	4da90913          	addi	s2,s2,1242 # 80021cc8 <cons+0x98>
    }
  ...
  release(&cons.lock);
    ...
    80005876:	3be50513          	addi	a0,a0,958 # 80021c30 <cons>
  ...
  return target - n;
    ...
    8000588c:	3a850513          	addi	a0,a0,936 # 80021c30 <cons>
    ...
    800058c2:	40f72523          	sw	a5,1034(a4) # 80021cc8 <cons+0x98>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    8000591c:	31850513          	addi	a0,a0,792 # 80021c30 <cons>
  ...
  release(&cons.lock);
    ...
    8000594a:	2ea50513          	addi	a0,a0,746 # 80021c30 <cons>
  ...
  switch(c){
    ...
    8000596e:	2c670713          	addi	a4,a4,710 # 80021c30 <cons>
    ...
    80005998:	29c78793          	addi	a5,a5,668 # 80021c30 <cons>
    ...
    800059c6:	3067a783          	lw	a5,774(a5) # 80021cc8 <cons+0x98>
    ...
    80005a26:	20e70713          	addi	a4,a4,526 # 80021c30 <cons>
    ...
    80005a3c:	28f72c23          	sw	a5,664(a4) # 80021cd0 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    80005a62:	1d278793          	addi	a5,a5,466 # 80021c30 <cons>
    ...
    80005a86:	24c7a523          	sw	a2,586(a5) # 80021ccc <cons+0x9c>
        wakeup(&cons.r);
    80005a8a:	0001c517          	auipc	a0,0x1c
    80005a8e:	23e50513          	addi	a0,a0,574 # 80021cc8 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80005ab0:	18450513          	addi	a0,a0,388 # 80021c30 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80005ac8:	e9478793          	addi	a5,a5,-364 # 80018958 <devsw>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    80005b9c:	1407ac23          	sw	zero,344(a5) # 80021cf0 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    80005bd0:	cef72023          	sw	a5,-800(a4) # 800088ac <panicked>
  for(;;)
...
0000000080005bd6 <printf>:
{
  ...
  locking = pr.locking;
    ...
    80005c0c:	0e8dad83          	lw	s11,232(s11) # 80021cf0 <pr+0x18>
  if(locking)
  ...
  consputc('x');
    ...
    80005c4a:	09250513          	addi	a0,a0,146 # 80021cd8 <pr>
  ...
  if(locking)
    ...
    80005da8:	f3450513          	addi	a0,a0,-204 # 80021cd8 <pr>
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    80005dc4:	f1848493          	addi	s1,s1,-232 # 80021cd8 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80005e24:	ed850513          	addi	a0,a0,-296 # 80021cf8 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80005e50:	a607a783          	lw	a5,-1440(a5) # 800088ac <panicked>
    for(;;)
      ;
  }
...
uartstart()
{
  while(1){
    ...
    80005e88:	a2c7b783          	ld	a5,-1492(a5) # 800088b0 <uart_tx_r>
    80005e8c:	00003717          	auipc	a4,0x3
    80005e90:	a2c73703          	ld	a4,-1492(a4) # 800088b8 <uart_tx_w>
    80005e94:	06f70a63          	beq	a4,a5,80005f08 <uartstart+0x84>
{
    ...
    80005eb2:	e4aa0a13          	addi	s4,s4,-438 # 80021cf8 <uart_tx_lock>
    uart_tx_r += 1;
    80005eb6:	00003497          	auipc	s1,0x3
    80005eba:	9fa48493          	addi	s1,s1,-1542 # 800088b0 <uart_tx_r>
    if(uart_tx_w == uart_tx_r){
    80005ebe:	00003997          	auipc	s3,0x3
    80005ec2:	9fa98993          	addi	s3,s3,-1542 # 800088b8 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
0000000080005f0a <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80005f20:	ddc50513          	addi	a0,a0,-548 # 80021cf8 <uart_tx_lock>
    80005f24:	00000097          	auipc	ra,0x0
    80005f28:	1a0080e7          	jalr	416(ra) # 800060c4 <acquire>
  if(panicked){
    80005f2c:	00003797          	auipc	a5,0x3
    80005f30:	9807a783          	lw	a5,-1664(a5) # 800088ac <panicked>
    80005f34:	e7c9                	bnez	a5,80005fbe <uartputc+0xb4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005f36:	00003717          	auipc	a4,0x3
    80005f3a:	98273703          	ld	a4,-1662(a4) # 800088b8 <uart_tx_w>
    80005f3e:	00003797          	auipc	a5,0x3
    80005f42:	9727b783          	ld	a5,-1678(a5) # 800088b0 <uart_tx_r>
    80005f46:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    80005f4a:	0001c997          	auipc	s3,0x1c
    80005f4e:	dae98993          	addi	s3,s3,-594 # 80021cf8 <uart_tx_lock>
    80005f52:	00003497          	auipc	s1,0x3
    80005f56:	95e48493          	addi	s1,s1,-1698 # 800088b0 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80005f5a:	00003917          	auipc	s2,0x3
    80005f5e:	95e90913          	addi	s2,s2,-1698 # 800088b8 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    80005f84:	d7848493          	addi	s1,s1,-648 # 80021cf8 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    80005f98:	92e7b223          	sd	a4,-1756(a5) # 800088b8 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    8000600a:	cf248493          	addi	s1,s1,-782 # 80021cf8 <uart_tx_lock>
