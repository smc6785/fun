...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hsvThresholdHue[] = {17.805755395683452, 40.95076400679116};
	double hsvThresholdSaturation[] = {98.60611510791367, 183.5653650254669};
	...
	double cvDilateIterations = 11.0;  // default Double
	...
	double cvErodeIterations = 9.0;  // default Double
	...
	double filterContoursMinArea = 20000.0;  // default Double
	double filterContoursMinPerimeter = 1400.0;  // default Double
	double filterContoursMinWidth = 300.0;  // default Double
	double filterContoursMaxWidth = 1000.0;  // default Double
	double filterContoursMinHeight = 200.0;  // default Double
	double filterContoursMaxHeight = 400.0;  // default Double
